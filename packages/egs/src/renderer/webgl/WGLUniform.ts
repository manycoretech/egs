...
export type UniformGeneralTypes = UniformUploadTypes | Color | Matrix3 | Matrix4 | Vector2 | Vector3 | Vector4
    | ReadonlyMatrix4 | ReadonlyMatrix3 | ReadonlyColor | ReadonlyVector2 | ReadonlyVector3 | ReadonlyVector4;

function setValue1f(gl: WebGLRenderingContext, location: any, v: number) { gl.uniform1f(location, v); }
function setValue1fv(gl: WebGLRenderingContext, location: any, v: Float32Array) { gl.uniform1fv(location, v); }
...
function setValue1iv(gl: WebGLRenderingContext, location: any, v: number[]) { gl.uniform1iv(location, v); }
function setValue2iv(gl: WebGLRenderingContext, location: any, v: number[]) { gl.uniform2iv(location, v); }

function setValue1ui(gl: WebGL2RenderingContext, location: any, v: number) { gl.uniform1ui(location, v); }
function setValue1uiv(gl: WebGL2RenderingContext, location: any, v: number[]) { gl.uniform1uiv(location, v); }
function setValue2uiv(gl: WebGL2RenderingContext, location: any, v: number[]) { gl.uniform2uiv(location, v); }

function setValue2m(gl: WebGLRenderingContext, location: any, v: Float32Array) { gl.uniformMatrix2fv(location, false, v); }
function setValue3m(gl: WebGLRenderingContext, location: any, v: Float32Array) { gl.uniformMatrix3fv(location, false, v); }
...
function getCorrectUpload(type: WebGLShaderDataType): any {
    switch (type) {
        case WebGLShaderDataType.Float: return setValue1f;
        case WebGLShaderDataType.FloatV: return setValue1fv;
        case WebGLShaderDataType.Vec2: return setValue2fv;
        case WebGLShaderDataType.Vec3: return setValue3fv;
        case WebGLShaderDataType.Vec4: return setValue4fv;

        case WebGLShaderDataType.Mat2: return setValue2m;
        case WebGLShaderDataType.Mat3: return setValue3m;
        case WebGLShaderDataType.Mat4: return setValue4m;
        ...
        case WebGLShaderDataType.USampler3D: return setValue1i;

        case WebGLShaderDataType.IntV: return setValue1iv;
        case WebGLShaderDataType.UintV: return setValue1uiv;

        case WebGLShaderDataType.IntVec2: return setValue2iv;
        case WebGLShaderDataType.UInt: return setValue1ui;
        case WebGLShaderDataType.UIntVec2: return setValue2uiv;

        case WebGLShaderDataType.ArraySampler2D: return setValue1iv;
        case WebGLShaderDataType.ArraySamplerCube: return setValue1iv;
    }
...
function isTypedArrayUniform(value: ArrayLikedUniform): value is Exclude<ArrayLikedUniform, number[]> {
    ...
    return ctor === Float32Array || ctor === Float32Array;
}
...
function getCorrectDiff(type: WebGLShaderDataType) {
    if (type === WebGLShaderDataType.Float || type === WebGLShaderDataType.Int || type === WebGLShaderDataType.UInt || type === WebGLShaderDataType.Bool) {
        return diffVal;
    } else {

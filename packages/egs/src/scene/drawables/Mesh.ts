...
import { Drawable, OutlineMode } from './Drawable';
...
import type { TriangleList, BufferGeometry } from '../../elements/geometries/containers/BufferGeometry';
import { drawableState, ContentBridge } from '../../ContentAPI';
import { createMeshBVH } from '../../BVH';

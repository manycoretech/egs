...
import { SplatFileType, PlyFile, SpzFile, SplatFile, SplatData, RawSplatData, CompressedSplatData, SuperCompressedSplatData, SogSplatData, type ISampler, ISamplerFormat, SH_MAPS, type IFile } from '@qunhe/egs-splat-loader';
